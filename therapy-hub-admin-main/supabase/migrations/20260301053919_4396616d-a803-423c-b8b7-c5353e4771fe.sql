...
-- Doctors: readable by all authenticated, manageable by admin
...
-- Patients: admin can see all, doctors can see assigned, patients see own
...
-- MCQ Questions: readable by all, manageable by admin
...
-- Assessments: admin sees all, patients see own, doctors see assigned patients
...
-- Appointments: admin sees all, participants see own
...
-- Chat messages: admin sees all, sender/receiver see own
...
-- Scoring config: admin can manage, all can read
